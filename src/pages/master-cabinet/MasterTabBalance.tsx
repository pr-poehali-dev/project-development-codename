...
export default function MasterTabBalance({
  ...
  return (
    <>
      ...
      <p className="text-gray-400 text-sm mb-5">Отклики на заявки — бесплатны. Токены нужны только для рекламы: буст услуги — 5 токенов, публикация услуги — 6–10 токенов/30 дней.</p>
