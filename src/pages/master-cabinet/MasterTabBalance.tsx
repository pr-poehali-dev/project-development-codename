...
export default function MasterTabBalance({
  ...
  return (
    <>
      ...
      <p className="text-gray-400 text-sm mb-5">Токены списываются когда заказчик выбирает вас исполнителем (−5 токенов). Буст услуги — 5 токенов. Публикация услуги — 6–10 токенов/30 дней.</p>
