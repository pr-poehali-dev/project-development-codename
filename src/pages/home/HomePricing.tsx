  ...
  return (
    <section id="pricing" className="py-16 px-4 bg-gradient-to-br from-violet-900/20 to-indigo-900/10 border-y border-white/5">
      <div className="max-w-5xl mx-auto">
        <h2 className="text-2xl font-bold text-center mb-3">Отклики бесплатны для мастеров</h2>
        <p className="text-gray-400 text-center mb-10">Откликайтесь на заявки и договаривайтесь с заказчиками без всякой оплаты. Токены нужны только для рекламы — буста и публикации ваших объявлений. Чем больше пакет — тем дешевле токен.</p>
          ...
          {[
            ...
            <div key={pkg.name} className={`bg-${pkg.color}-600/10 border border-${pkg.color}-500/20 rounded-2xl p-6 flex flex-col gap-3`}>
              ...
              <ul className="space-y-1.5 mt-1">
                {["Без срока действия", "Мгновенное зачисление", "Буст и публикация услуг"].map((f) => (
