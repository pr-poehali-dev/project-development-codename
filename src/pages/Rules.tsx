      ...
      <div className="max-w-3xl mx-auto px-4 py-10 space-y-8">
        ...
        <div className="bg-red-600/10 border border-red-500/30 rounded-2xl p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 className="text-red-400 font-bold text-lg mb-2">Передача контактов до договорённости — запрещена</h2>
              <p className="text-gray-300 text-sm leading-relaxed mb-3">
                Запрещено передавать личные контакты (телефон, email, ссылки на мессенджеры) в чате до взаимного подтверждения через кнопку «Договорились». Это защищает обе стороны от мошенников.
              </p>
              <div className="space-y-2">
                <div className="flex items-start gap-2">
                  <Icon name="X" size={14} className="text-red-400 mt-0.5 flex-shrink-0" />
                  <p className="text-gray-400 text-sm">Запрещено писать номер телефона, email или ссылки в чате до нажатия «Договорились»</p>
                </div>
                <div className="flex items-start gap-2">
                  <Icon name="X" size={14} className="text-red-400 mt-0.5 flex-shrink-0" />
                  <p className="text-gray-400 text-sm">Запрещено просить предоплату до начала выполнения работы</p>
                </div>
                <div className="flex items-start gap-2">
                  <Icon name="X" size={14} className="text-red-400 mt-0.5 flex-shrink-0" />
                  <p className="text-gray-400 text-sm">Запрещено использовать платформу только для сбора контактов без реального намерения сотрудничать</p>
                </div>
              </div>
              <div className="mt-3 bg-blue-500/10 border border-blue-500/20 rounded-xl px-4 py-3">
                <p className="text-blue-300 text-sm flex items-start gap-2">
                  <Icon name="Info" size={14} className="mt-0.5 flex-shrink-0 text-blue-400" />
                  Оплата услуг производится напрямую между заказчиком и мастером после выполнения работы — на условиях, о которых они договорились в чате.
                </p>
              </div>
              <div className="mt-2 bg-red-500/10 rounded-xl px-4 py-3">
                <p className="text-red-300 text-sm font-semibold">⛔ Санкции за передачу контактов до договорённости: блокировка аккаунта.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="space-y-2.5">
                {[
                  ...
                  "Проверяйте адресную строку браузера — сайт HandyMan работает только на домене хандиман.рф.",
                  "Платите мастеру только после выполнения работы — лично или переводом. Предоплата незнакомому человеку — риск мошенничества.",
                  "HandyMan не участвует в денежных расчётах и никогда не запрашивает данные карты.",
                ].map((text, i) => (
        ...
        <div className="bg-white/4 border border-white/8 rounded-2xl p-6">
          ...
          <div className="space-y-3">
            {[
              ...
              "Оплата за услуги производится лично между вами и заказчиком после выполнения работы — наличными или переводом, на ваших условиях.",
        ...
        <div className="bg-white/4 border border-white/8 rounded-2xl p-6">
          ...
          <div className="space-y-3">
            {[
              ...
              "Оплачивайте услуги лично мастеру после выполнения работы — HandyMan не участвует в расчётах между пользователями.",
            ].map((text, i) => (
              <div key={i} className="flex items-start gap-2">
                <Icon name="Circle" size={6} className="text-gray-600 mt-1.5 flex-shrink-0" />
                <p className="text-gray-300 text-sm leading-relaxed">{text}</p>
