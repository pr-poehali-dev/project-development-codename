      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-gray-300 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-2">Сервис <strong className="text-white">ХэндиМэн</strong> (сайт handysen.poehali.dev, далее — «Сервис») — это информационная платформа, соединяющая заказчиков бытовых услуг с мастерами-исполнителями.</p>
          ...
          <section>
            ...
            <p>Исполнитель оказывает Пользователю (мастеру) информационную услугу — предоставление доступа к базе заявок от заказчиков бытовых услуг на платформе ХэндиМэн. Услуга предоставляется в виде «откликов» — единиц доступа, позволяющих мастеру откликнуться на заявку заказчика и передать ему свои контактные данные.</p>
          </section>
          ...
          <section>
            ...
            <div className="bg-white/4 border border-white/8 rounded-xl p-5 space-y-2">
              ...
              <p><span className="text-gray-500">Сервис:</span> ХэндиМэн</p>
            </div>
          </section>
        ...
        <div className="mt-12 pt-8 border-t border-white/8 text-gray-600 text-xs">
          © 2026 ХэндиМэн. Все права защищены.
        </div>
      </div>
    </div>
  );
