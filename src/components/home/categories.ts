export const categories = [
  ...
  { name: "Свадьба и торжества", subcategories: ["Тамада и ведущий", "Флорист и декор", "Выездная регистрация", "Кейтеринг", "Свадебный торт", "Организация праздника"] },
  { name: "Курьер и доставка", subcategories: ["Срочная доставка", "Доставка по городу", "Межгородская доставка", "Доставка документов", "Доставка цветов", "Грузовая доставка"] },
  { name: "Охрана и безопасность", subcategories: ["Установка сигнализации", "Видеонаблюдение", "Установка замков", "Охрана мероприятий", "Домофоны и СКУД", "Пожарная безопасность"] },
  { name: "Медицина на дому", subcategories: ["Медсестра на дом", "Капельница", "Забор анализов", "Массаж лечебный", "Психолог онлайн", "Логопед"] },
  { name: "Переводчик", subcategories: ["Устный перевод", "Письменный перевод", "Нотариальный перевод", "Синхронный перевод", "Перевод документов", "Апостиль"] },
  { name: "Хендмейд", subcategories: ["Пошив одежды", "Ювелирные украшения", "Роспись и гравировка", "Вязание и шитьё", "Декупаж", "Подарки на заказ"] },
